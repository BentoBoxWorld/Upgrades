...
import world.bentobox.upgrades.dataobjects.adapter.PriceDBAdapter;
import world.bentobox.upgrades.dataobjects.adapter.RewardDBAdapter;
...
public class UpgradeTier implements DataObject {
     ...
     */
    @Expose
    @JsonAdapter(PriceDBAdapter.class)
    private List<PriceDB> prices = new ArrayList<>();

    /**
     * List of rewards given at each level of this tier
     */
    @Expose
    @JsonAdapter(RewardDBAdapter.class)
    private List<RewardDB> rewards = new ArrayList<>();
     ...
     * @return the rewards
     */
    public List<RewardDB> getRewards() {
        return rewards;
    }
     ...
     */
    public void setRewards(List<RewardDB> rewards) {
